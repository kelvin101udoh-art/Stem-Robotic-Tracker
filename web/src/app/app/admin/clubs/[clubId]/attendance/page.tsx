...
export default function AttendanceDashboardPage() {
    ...
    const [range] = useState<"today">("today");
    ...
    return (
        <main className="relative min-h-screen w-full overflow-x-clip text-slate-900">
            ...
            <div className="mx-auto w-full max-w-[1500px] px-4 py-6 sm:px-6 lg:px-8">
                ...
                {/* ✅ Today Snapshot (Dashboard is for Today only — History handles older sessions) */}
                <div className="mt-6 overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-[0_18px_60px_-42px_rgba(2,6,23,0.45)]">
                    <div className="relative bg-gradient-to-r from-indigo-50 via-white to-cyan-50 px-5 py-5 sm:px-6">
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div className="min-w-0">
                                ...
                                <div className="mt-2 text-xl font-semibold tracking-tight text-slate-900">
                                    Today’s attendance performance & business insights
                                </div>
                        ...
                        {saveMsg ? (
                            <div className="mt-4 rounded-xl border border-slate-200 bg-white/70 px-3 py-2 text-sm text-slate-700">
                                {saveMsg}
                            </div>
                        ) : null}
                    </div>
