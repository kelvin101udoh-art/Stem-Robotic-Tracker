          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {tag ? (
                ...
                <span className="rounded-full border border-slate-200 bg-white/70 px-2.5 py-1 text-[11px] font-semibold text-slate-700">—</span>
              )}
            ...
            <div className="mt-1 text-xs text-slate-600">
              Evidence + checklist + attendance signals • Azure automation writes insights continuously
            </div>
          </div>
